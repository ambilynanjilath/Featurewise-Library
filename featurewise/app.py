...
def main():
    ...
    st.image('/home/user/Documents/Datahut_Internship/project/featurewise/featurewise_logo.png', width=200, use_column_width=False)  # Adjust the path and width as needed
    ...
    if uploaded_file is not None:
        ...
        try:
            ...
            custom_filename = st.sidebar.text_input("Enter a filename", default_filename)
            csv = st.session_state.df.to_csv(index=False)
            st.sidebar.download_button("Download Transformed CSV", csv, custom_filename, "text/csv")
        except Exception as e:
